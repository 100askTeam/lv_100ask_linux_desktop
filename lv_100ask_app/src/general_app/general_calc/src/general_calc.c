 ...
 * Change Logs:
 * Date           Author          Notes
 * 2021-10-17     zhouyuebiao     First version
 ******************************************************************************
 * @attention
 *
...
#if 1 //LV_USE_100ASK_CALC


#include <stdio.h>
#include <stdlib.h>
#include <ctype.h>
#include "general_calc.h"
...
static void lv_100ask_calc_init(void)
{
    ...
    lv_obj_set_style_text_font(g_calc_ta, &lv_font_montserrat_34, 0);  // text font
